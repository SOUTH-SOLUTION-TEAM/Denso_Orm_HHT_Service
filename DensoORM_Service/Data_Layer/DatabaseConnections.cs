...
namespace DensoORM_Service.Data_Layer
{
    public class DatabaseConnections
    {
        ...
        public string strSqlConn = ConfigurationManager.ConnectionStrings["dbLocal"].ConnectionString;
        ...
        public bool Connect()
        {
            try
            {
                strSqlConn = ConfigurationManager.ConnectionStrings["dbLocal"].ConnectionString;
